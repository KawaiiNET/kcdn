/*Generated at: 1565673979, Cache ends at: 1565709979,en_US*/

/**
 * Copyright (c) 2019-present, Webhosting Fox LLC. All rights reserved.
 *
 * You are hereby granted a non-exclusive, worldwide, royalty-free license to use,
 * copy, modify, and distribute this software in source code or binary form for use
 * in connection with the web services and APIs provided by Webhosting Fox.
 *
 * As with any software that integrates with the Webhosting Fox platform, your use of
 * this software is subject to the Webhosting Fox Platform Policy
 * [https://www.webhostingfox.net/legal]. This copyright notice shall be
...
else{window.attachEvent('onmessage',cmpMsgHandler);}})();window.__cmp('init',{'Language':'en','Initial Screen Reject Button Text':'I do not accept','Initial Screen Accept Button Text':'I accept','Purpose Screen Body Text':'You can set your consent preferences and determine how you want your data to be used based on the purposes below. You may set your preferences for us independently from those of third-party partners. Each purpose has a description so that you know how we and partners use your data.','Vendor Screen Body Text':'You can set consent preferences for each individual third-party company below. Expand each company list item to see what purposes they use data for to help make your choices. In some cases, companies may disclose that they use your data without asking for your consent, based on their legitimate interests. You can click on their privacy policies for more information and to opt out.','Vendor Screen Accept All Button Text':'Accept all','Vendor Screen Reject All Button Text':'Reject all','Initial Screen Body Text':'We and our partners use technology such as cookies on our site to personalise content and ads, provide social media features, and analyse our traffic. Click below to consent to the use of this technology across the web. You can change your mind and change your consent choices at anytime by returning to this site.','Initial Screen Body Text Option':1,'Publisher Name':'Webhosting Fox, LLC','Display UI':'always','Publisher Purpose IDs':[1,2,3,4,5],'Post Consent Page':'https://www.webhostingfox.net/privacy','Consent Scope':'service group','Consent Scope Group URL':'https://consent.whfnetwork.com/api?origin='+document.domain,'Publisher Logo':'https://data.cdn.whfnetwork.com/images/logo.png',});
/** Hashkey: 78226ec6bcd021eb7302894a9b0916a49b06d38b **/
