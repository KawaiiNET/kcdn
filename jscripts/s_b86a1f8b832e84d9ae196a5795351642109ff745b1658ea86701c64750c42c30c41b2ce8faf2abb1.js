...
jQuery('tcrmailbody').html(reue_header+reue_content+reue_footer);jQuery('#inbox_noti').html(mail_count.unread);jQuery('#pm_total').html(mail_count.inbox+" of "+mail_count.total);jQuery('#sent_noti').html(mail_count.sent);jQuery("td .timeago").timeago();});}
