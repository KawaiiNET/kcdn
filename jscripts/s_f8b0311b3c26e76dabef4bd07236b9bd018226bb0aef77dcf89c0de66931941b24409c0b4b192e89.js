//	Application.js requires the following libs in order to run (as listed): Login.js
...
!function(n){n.fn.makemecenter=function(i){function t(i){return i.each(function(){var i=n(this);o(i)})}var a=n.extend({position:"absolute",horizontal:!0,vertical:!0,parentRelative:window,complete:null,marginLeft:null,marginRight:null,marginTop:null,paddingLeft:null,paddingRight:null,paddingTop:null,paddingBottom:null,is_onload:!0,is_onresize:!0,is_ondatachange:!0,is_animate:!1},i),e=this;n.fn.makemecenter.destroy=function(){return e.each(function(){n(window).off("resize.makemecenter")})};var o=function(i){var t=n(a.parentRelative),e=n(t).innerHeight(),o=n(t).innerWidth();t.css({position:"relative"}),i.css({margin:"",padding:""}),i.css({position:a.position,"margin-left":a.marginLeft,"margin-right":a.marginRight,"margin-top":a.marginTop,"padding-left":a.paddingLeft,"padding-right":a.paddingRight,"padding-top":a.paddingTop,"padding-bottom":a.paddingBottom});var r=i.width();if(a.horizontal){var d=(o-r-a.marginLeft-a.marginRight-a.paddingLeft-a.paddingRight)/2;0>=d&&(d=0),i.css({left:d})}var g=i.height();if(a.vertical){var l=(e-g-a.marginTop-a.paddingTop-a.paddingBottom)/2;0>=l&&(l=0);var p={top:l,"margin-bottom":0};a.is_animate?i.animate(p):i.css(p)}return n.isFunction(a.complete)?a.complete.call(i):void 0};t(e),a.is_onload&&n(window).load(function(){t(e)}),a.is_onresize&&n(window).on("resize.makemecenter",function(){t(e)})}}(jQuery);

var app = {
		w:window,
		d:document,
		title:function(a){this.d.title=a;},
		l:document.location.href,
		e:encodeURIComponent,
		domain:function(a){if(a==""||a==null||a=="undefined"){return document.domain;}else{return a;};},
		check:{internet:internalCheck},
		browser:function() {var check = false;(function(a){if(/(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|iris|kindle|lge |maemo|midp|mmp|mobile.+firefox|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows ce|xda|xiino/i.test(a)||/1207|6310|6590|3gso|4thp|50[1-6]i|770s|802s|a wa|abac|ac(er|oo|s\-)|ai(ko|rn)|al(av|ca|co)|amoi|an(ex|ny|yw)|aptu|ar(ch|go)|as(te|us)|attw|au(di|\-m|r |s )|avan|be(ck|ll|nq)|bi(lb|rd)|bl(ac|az)|br(e|v)w|bumb|bw\-(n|u)|c55\/|capi|ccwa|cdm\-|cell|chtm|cldc|cmd\-|co(mp|nd)|craw|da(it|ll|ng)|dbte|dc\-s|devi|dica|dmob|do(c|p)o|ds(12|\-d)|el(49|ai)|em(l2|ul)|er(ic|k0)|esl8|ez([4-7]0|os|wa|ze)|fetc|fly(\-|_)|g1 u|g560|gene|gf\-5|g\-mo|go(\.w|od)|gr(ad|un)|haie|hcit|hd\-(m|p|t)|hei\-|hi(pt|ta)|hp( i|ip)|hs\-c|ht(c(\-| |_|a|g|p|s|t)|tp)|hu(aw|tc)|i\-(20|go|ma)|i230|iac( |\-|\/)|ibro|idea|ig01|ikom|im1k|inno|ipaq|iris|ja(t|v)a|jbro|jemu|jigs|kddi|keji|kgt( |\/)|klon|kpt |kwc\-|kyo(c|k)|le(no|xi)|lg( g|\/(k|l|u)|50|54|\-[a-w])|libw|lynx|m1\-w|m3ga|m50\/|ma(te|ui|xo)|mc(01|21|ca)|m\-cr|me(rc|ri)|mi(o8|oa|ts)|mmef|mo(01|02|bi|de|do|t(\-| |o|v)|zz)|mt(50|p1|v )|mwbp|mywa|n10[0-2]|n20[2-3]|n30(0|2)|n50(0|2|5)|n7(0(0|1)|10)|ne((c|m)\-|on|tf|wf|wg|wt)|nok(6|i)|nzph|o2im|op(ti|wv)|oran|owg1|p800|pan(a|d|t)|pdxg|pg(13|\-([1-8]|c))|phil|pire|pl(ay|uc)|pn\-2|po(ck|rt|se)|prox|psio|pt\-g|qa\-a|qc(07|12|21|32|60|\-[2-7]|i\-)|qtek|r380|r600|raks|rim9|ro(ve|zo)|s55\/|sa(ge|ma|mm|ms|ny|va)|sc(01|h\-|oo|p\-)|sdk\/|se(c(\-|0|1)|47|mc|nd|ri)|sgh\-|shar|sie(\-|m)|sk\-0|sl(45|id)|sm(al|ar|b3|it|t5)|so(ft|ny)|sp(01|h\-|v\-|v )|sy(01|mb)|t2(18|50)|t6(00|10|18)|ta(gt|lk)|tcl\-|tdg\-|tel(i|m)|tim\-|t\-mo|to(pl|sh)|ts(70|m\-|m3|m5)|tx\-9|up(\.b|g1|si)|utst|v400|v750|veri|vi(rg|te)|vk(40|5[0-3]|\-v)|vm40|voda|vulc|vx(52|53|60|61|70|80|81|83|85|98)|w3c(\-| )|webc|whit|wi(g |nc|nw)|wmlb|wonu|x700|yas\-|your|zeto|zte\-/i.test(a.substr(0,4)))check = true})(navigator.userAgent||navigator.vendor||window.opera);return check;},
		a:function(as){alert(as);},
		f:{
			logout:function(id,authKey,secretKey,csrf){var fa=this.d.createElement('form');f.setAttribute('id',id);fa.setAttribute('method','post');var ak=document.createElement("input");ak.setAttribute('type','hidden');ak.setAttribute('name','authKey');ak.setAttribute('value',authKey);var sk=document.createElement("input");sk.setAttribute('type','hidden');sk.setAttribute('name','secretKey');sk.setAttribute('value',secretKey);var ct=document.createElement("input");ct.setAttribute('type','hidden');ct.setAttribute('name','csrf_token');ct.setAttribute('value',csrf);fa.appendChild(ak);fa.appendChild(sk);fa.appendChild(ct);this.d.getElementByTagNme('body')[0].appendChild(fa);}
		},
		dom:function(id){return app.d.getElementById(id);},
		focus:function(id){return app.d.getElementById(id).focus();},
		http:{
			post:function(inURL, inParams, inReturnFunction, inReturnParams){fgServerRequestPC(inURL, inParams, inReturnFunction, inReturnParams);},
			request:function(inURL, inReturnFunction, inReturnParams){fgServerRequest(inURL, inReturnFunction, inReturnParams);},
			get:function(inURL, inReturnFunction, inReturnParams){fgServerRequest(inURL, inReturnFunction, inReturnParams);}
		},
		text:function(id,text){return app.d.getElementById(id).value=text;},
		lang:{
			keysok:"Key/Private Key OK!",
			login:function(s){return "Welcome back, "+s},
			error:{
				unknown:"Unknown error occured!",
				kpim:"Key/Private Key Mismatch!",
				inactive:"Keys are inactive!",
				unameorpword: "That password was incorrect.<br/>Please make sure you are using your My Trading Portal account information.",
				crsfcheck:"Please wait for the security token to refresh!"
				}
			}
		};
app.activity = 0;
app.sso = 0;
	...
	app.checkInternet = function(){
		app.http.post("https://"+app.domain()+"/post", "_checkNetworkActivity", "_checkInternet", "");
	}
	
	app.heartbeat = function(){
		app.http.post("https://"+app.domain()+"/post", "_heartBeat", "_hb", "");
	}
	
	app.load = function(){
		if(app.get['return'] && app.get['return'] != null)
		{
			var urX = "https://"+app.domain()+"/post?return="+app.e(app.get['return']);
		}
		else
		{
			var urX = "https://"+app.domain()+"/post";
		}
		jQuery.post(urX, {"_loginTemplate":""}, function(a){
			jQuery('#loginTemplate').html(a.template);
			if(app.browser() == true){
		setTimeout(function(){app.d.getElementById('appLogo').setAttribute('style','display:none;display:hidden;');
			app.d.getElementById('loginMSG').innerHTML='Log in to MyTP';
			//$('body').css({'right' : '0px', 'margin-right' : '100px'});
			//$('body').addClass('bodyEX');
			$('#loginBox').css({'right' : '0px', 'margin-right' : '100px'});
			$("body").makemecenter();
			$("#loginBox").makemecenter({
				marginLeft:10,
				marginRight: 10,
				paddingLeft: 10,
				paddingRight: 10,
			...
			if(app.get['username'] && app.get['username'] != null)
		{
			app.d.getElementById('usern').value=app.get['username'];
			app.d.getElementById('usern').setAttribute('disabled','disabled');
			app.d.getElementById('usernx').value=app.get['username'];
			app.focus("userp");
			app.d.getElementById('signin_messages').setAttribute('style','display:none;display:hidden;');
			app.d.getElementById('signin_load').setAttribute('style','display:none;display:hidden;');
			app.d.getElementById('signin_errors').setAttribute('style','display:visible;');
			app.d.getElementById('signin_errors').innerHTML="Please enter your password<br/>";
		}
		else
		{
			app.focus("usern");
	...
	{
		setTimeout(function(){jQuery('#loginTemplate').prop('style','');
	...
	function setCSRF(){
		app.http.post("https://"+app.domain()+"/post", "_genCSRF", "_", "");
	}

	function logout(){
		setCSRF();
		app.http.post("https://"+app.domain()+"/post", "_logMeOut&csrf_token="+fgGet("csrf_token", "value", 0), "_logout", "");
	}
	
	function _logout(a){
		if (a.trim()==="LOGOUTERROR"){
			app.a("Logout failed!");
			return false;
		}
		else if (a.trim()==="LOGOUTOK"){
			document.location.href="https://"+app.domain()+"/login";
		}
		else
		{
			app.a("Logout failed!");
	...
	function _(m){
		app.text("csrf_token",m.trim());
	}
	
	function _loginTemplate(m){
		app.d.getElementById('loginPassage').innerHTML=m;
	}
	
	function _checkInternet(m){
		
		if(m.trim() == 'CONNEXION'){
		//User is connected :D
		if(app.check.internet == 2)
		{
			app.check.internet = 1;
			app.activity = 0;
			app.d.getElementById('signin').removeAttribute('disabled');
			app.d.getElementById('usern').removeAttribute('disabled');
			app.d.getElementById('userp').removeAttribute('disabled');
			app.d.getElementById('loginSys').setAttribute('style','display:visible;');
			app.d.getElementById('signin_errors').setAttribute('style','display:none;display:hidden;');
			app.d.getElementById('signin_load').setAttribute('style','display:none;display:hidden;');
			app.d.getElementById('signin_messages').setAttribute('style','display:visible;');
			app.d.getElementById('signin_messages').innerHTML="Connected!";
			app.d.getElementById('signin').innerHTML='Sign in';
			app.d.getElementById('usern').value="";
			app.d.getElementById('userp').value="";
			app.focus('usern');
			setCSRF();
			clearTimeout(initNetwork);
			var axsuus = setInterval(function(){app.checkInternet();}, 6000);
			setTimeout(function(){clean_msgs();}, 10000);
			return false;
		}
		else if(app.check.internet == 1)
		{
			//return false;
		}
		else
		...
		else if(m.trim() == "Failed")
		{
			//User is not connected :C
			//app.check.internet == 2;
			app.activity = 0;
			app.d.getElementById('signin').setAttribute('disabled','disabled');
			app.d.getElementById('usern').setAttribute('disabled','disabled');
			app.d.getElementById('userp').setAttribute('disabled','disabled');
			app.d.getElementById('loginSys').setAttribute('style','display:none;display:hidden;');
			app.d.getElementById('signin_errors').setAttribute('style','display:none;display:hidden;');
			app.d.getElementById('signin_messages').setAttribute('style','display:none;display:hidden;');
			app.d.getElementById('signin_load').setAttribute('style','display:visible;');
			app.d.getElementById('signin_errors').setAttribute('style','display:visible;');
			app.d.getElementById('signin_errors').innerHTML="Whoops!";
			app.d.getElementById('signin_load').innerHTML="Please check your network connection settings.<br/><a id=\"appInternetReConnect\" onclick=\"app.check.internet=2;app.checkInternet();\" style=\"text-decoration:none;color:gray;cursor:pointer;\"><u>Connect</u></a>";
			app.d.getElementById('signin').innerHTML='Sign in';
			app.d.getElementById('usern').value="";
			app.d.getElementById('usernx').value="";
			app.d.getElementById('userp').value="";
			app.d.getElementById('userpx').value="";
			clearInterval(x);
			clearInterval(axsuus);
			clearInterval(axsuus);
			var secsx = 5, displayx = document.querySelector('#appInternetReConnect');
			initNetwork = setTimeout(function(){autoConnect(secsx, displayx);},1000);
			return false;
		}
		else
		{
			//For now, let's assume CONNEXION is TRUE
			if(app.check.internet == 2)
		{
			/*app.check.internet = 1;
			app.activity = 0;
	...
	function login(){
		if(app.activity == 3)
		{
				...
				app.d.getElementById('signin_messages').setAttribute('style','display:none;display:hidden;');
				app.d.getElementById('signin_load').setAttribute('style','display:visible;');
				app.d.getElementById('signin_load').innerHTML='Signing into the CRM<br/><img src="https://akamai-cdn.mytradingportal.com/img/pingbarlogin.gif" style="height:11px;border:0;top:-1px;" /><br/>';
				app.http.post("https://crm.marketsandyou.com/app/index.php/zurmo/default/login", "YII_CSRF_TOKEN="+ document.getElementById('fx').contentWindow.document.getElementsByName('YII_CSRF_TOKEN')[0].value +"&LoginForm[username]="+ strip_tags(fgGet("usern", "value", 0)) +"&LoginForm[password]="+ strip_tags(fgGet("userp", "value", 0)) + "&LoginForm[rememberMe]=1&ajax=login-form&save=save", "response", "");
		}
		else if(app.activity == 2)
		{
			if(fgGet("usern", "value", 0) ==  fgGet("userp", "value", 0))
			{
				app.activity = 1;
				app.d.getElementById('usernx').value=fgGet("usern", "value", 0);
				app.d.getElementById('userpx').value=fgGet("userp", "value", 0);
				app.d.getElementById('usern').setAttribute('disabled','disabled');
				app.d.getElementById('userp').setAttribute('disabled','disabled');
				app.d.getElementById('signin_errors').setAttribute('style','display:none;display:hidden;');
				app.d.getElementById('signin_messages').setAttribute('style','display:none;display:hidden;');
				app.d.getElementById('signin_load').setAttribute('style','display:visible;');
				app.d.getElementById('signin_load').innerHTML='Verifying<br/><img src="https://akamai-cdn.mytradingportal.com/img/pingbarlogin.gif" style="height:11px;border:0;top:-1px;" /><br/>';
				setTimeout(function(){app.http.post("https://"+app.domain()+"/post", "_resetPassword&token="+ strip_tags(fgGet("rKey", "value", 0)) +"&uid="+ strip_tags(fgGet("uid", "value", 0)) + "&newPass="+ strip_tags(fgGet("usernx", "value", 0)) + "&verPass="+ strip_tags(fgGet("userpx", "value", 0)) + "&csrf_token=" + strip_tags(fgGet("csrf_token", "value", 0)), "response", "");},1000);
			}
			else if(fgGet("usern", "value", 0) !=  fgGet("userp", "value", 0))
			{
				app.activity = 2;
				app.d.getElementById('usern').value="";
				app.d.getElementById('usernx').value="";
				...
				app.d.getElementById('signin_load').setAttribute('style','display:none;display:hidden;');
				app.d.getElementById('signin_messages').setAttribute('style','display:none;display:hidden;');
				app.d.getElementById('signin_errors').innerHTML="Your new password does not match!";
				app.d.getElementById('signin_errors').setAttribute('style','display:visible;');
				app.focus('usern');
				return false;
			}
			else
			{
				...
				app.d.getElementById('signin_load').setAttribute('style','display:none;display:hidden;');
				app.d.getElementById('signin_messages').setAttribute('style','display:none;display:hidden;');
				app.d.getElementById('signin_errors').innerHTML="Unknown error occured!";
				app.d.getElementById('signin_errors').setAttribute('style','display:visible;');
				app.focus('usern');
				return false;
			}
		}
		else if (app.activity == 0)
		{
			if(app.sso == 1)
			{
				app.activity = 1;
				...
				app.d.getElementById('signin_errors').setAttribute('style','display:none;display:hidden;');
				app.d.getElementById('signin_messages').setAttribute('style','display:none;display:hidden;');
				setTimeout(function(){app.http.post("https://"+app.domain()+"/post", "_authSSO&username="+ strip_tags(fgGet("usernx", "value", 0)) + "&csrf_token=" + strip_tags(fgGet("csrf_token", "value", 0)), "response", "");},1000);
			}
			else if(fgGet("usern", "value", 0).length == 64 && fgGet("userp", "value", 0).length == 64)
			{
				app.activity = 0;
				app.d.getElementById('usern').value="";
				app.d.getElementById('usernx').value="";
				...
				app.d.getElementById('signin_load').setAttribute('style','display:none;display:hidden;');
				app.d.getElementById('signin_messages').setAttribute('style','display:none;display:hidden;');
				app.d.getElementById('signin_errors').innerHTML="You cannot login using your session keys.";
				app.d.getElementById('signin_errors').setAttribute('style','display:visible;');
				app.focus('usern');
				return false;
			}
			else if(fgGet("usern", "value", 0).length == 0 || fgGet("usern", "value", 0).length > 64)
			{
				app.activity = 0;
				app.d.getElementById('usernx').value="";
				app.d.getElementById('signin_load').setAttribute('style','display:none;display:hidden;');
				app.d.getElementById('signin_messages').setAttribute('style','display:none;display:hidden;');
				app.d.getElementById('signin_errors').innerHTML="Please enter a username linked to your MyTP account.";
				app.d.getElementById('signin_errors').setAttribute('style','display:visible;');
				app.focus('usern');
				return false;
			}
			else if(fgGet("usern", "value", 0).length < 4)
			{
				app.activity = 0;
				app.d.getElementById('usernx').value="";
				app.d.getElementById('signin_load').setAttribute('style','display:none;display:hidden;');
				app.d.getElementById('signin_messages').setAttribute('style','display:none;display:hidden;');
				app.d.getElementById('signin_errors').innerHTML="Your MyTP account username should be longer than 4 characters.";
				app.d.getElementById('signin_errors').setAttribute('style','display:visible;');
				app.focus('usern');
				return false;
			}
			else if(fgGet("userp", "value", 0).length < 5)
			{
				app.activity = 0;
				app.d.getElementById('userpx').value="";
				app.d.getElementById('signin_load').setAttribute('style','display:none;display:hidden;');
				app.d.getElementById('signin_messages').setAttribute('style','display:none;display:hidden;');
				app.d.getElementById('signin_errors').innerHTML="Your MyTP account password should be longer than 5 characters.";
				app.d.getElementById('signin_errors').setAttribute('style','display:visible;');
				app.focus('userp');
				return false;
			}
			else if(fgGet("usern", "value", 0).length == 64 && fgGet("userp", "value", 0).length < 64)
			{
				...
				app.d.getElementById('signin_load').setAttribute('style','display:none;display:hidden;');
				app.d.getElementById('signin_messages').setAttribute('style','display:none;display:hidden;');
				app.d.getElementById('signin_errors').innerHTML="Please enter a valid secret key.";
				app.d.getElementById('signin_errors').setAttribute('style','display:visible;');
				app.focus('userp');
				return false;
			}	
			else if(fgGet("userp", "value", 0).length == 0)
			{
				app.activity = 0;
				app.d.getElementById('userpx').value="";
				app.d.getElementById('signin_load').setAttribute('style','display:none;display:hidden;');
				app.d.getElementById('signin_messages').setAttribute('style','display:none;display:hidden;');
				app.d.getElementById('signin_errors').innerHTML="Please enter a password linked to your MyTP account.";
				app.d.getElementById('signin_errors').setAttribute('style','display:visible;');
				app.focus('userp');
				return false;
			}
			else
			{
				...
				app.d.getElementById('userp').setAttribute('disabled','disabled');
				app.d.getElementById('signin_load').setAttribute('style','display:visible;');
				app.d.getElementById('signin_load').innerHTML='Signing in<br/><img src="https://akamai-cdn.mytradingportal.com/img/pingbarlogin.gif" style="height:11px;border:0;top:-1px;" /><br/>';
				app.d.getElementById('signin').setAttribute('disabled','disabled');
				app.d.getElementById('signin_errors').setAttribute('style','display:none;display:hidden;');
				app.d.getElementById('signin_messages').setAttribute('style','display:none;display:hidden;');
				app.http.post("https://"+app.domain()+"/post", "_authE&user=" + strip_tags(fgGet("usernx", "value", 0)) + "&pass=" + strip_tags(fgGet("userpx", "value", 0)) + "&csrf_token=" + strip_tags(fgGet("csrf_token", "value", 0)), "response", "");
			}
		}
		else
		{
	...
	function response(returnCall) {
		if(returnCall.trim() == '[]')
		{
			...
			app.d.getElementById('signin_messages').setAttribute('style','display:none;display:hidden;');
			app.d.getElementById('signin_load').setAttribute('style','display:visible;');
			app.d.getElementById('signin_load').innerHTML='Taking you to the CRM<br/><img src="https://akamai-cdn.mytradingportal.com/img/pingbarlogin.gif" style="height:11px;border:0;top:-1px;" /><br/>';
			setTimeout(function(){document.location.href="https://crm.marketsandyou.com/";app.d.getElementById('usern').value="";app.d.getElementById('userp').value="";},2000);
			return false;
		}
		else if(returnCall.trim() == '{"LoginForm_password":["Incorrect username or password."]}')
		{
			app.activity = 3;
			app.d.getElementById('signin').removeAttribute('disabled');
			app.d.getElementById('usern').removeAttribute('disabled');
			...
			app.d.getElementById('signin_load').setAttribute('style','display:none;display:hidden;');
			app.d.getElementById('signin_errors').setAttribute('style','display:visible;');
			app.d.getElementById('signin_errors').innerHTML="Your passwords do not match.";
			app.d.getElementById('signin').innerHTML='Sign in';
			app.d.getElementById('usern').value="";
			app.d.getElementById('userp').value="";
			app.focus('usern');
		...
		else if(returnCall.trim() == "nP vP Match")
		{
			app.activity = 2;
			app.d.getElementById('signin').removeAttribute('disabled');
			app.d.getElementById('usern').removeAttribute('disabled');
			...
			app.d.getElementById('signin_load').setAttribute('style','display:visible;');
			app.d.getElementById('signin_errors').setAttribute('style','display:visible;');
			app.d.getElementById('signin_errors').innerHTML="";
			app.d.getElementById('signin_messages').innerHTML="";
			app.d.getElementById('signin_load').innerHTML="";
			app.d.getElementById('signin_messages').innerHTML="Your account has been unsuspended<br/>";
			app.d.getElementById('signin_load').innerHTML="Please wait<br/><img src=\"https://akamai-cdn.mytradingportal.com/img/pingbarlogin.gif\" style=\"height:11px;border:0;top:-1px;\" /><br/>";
			app.d.getElementById('signin').innerHTML='Sign in';
			app.d.getElementById('usern').value="";
			app.d.getElementById('usernx').value="";
			app.d.getElementById('userp').value="";
			app.d.getElementById('userpx').value="";
			setTimeout(function(){top.location.href='https://'+app.domain()+'/';},2000);
			return false;
		}
		else if(returnCall.trim() == "nP vP Mismatch")
		{
			app.activity = 2;
			app.d.getElementById('signin').removeAttribute('disabled');
			app.d.getElementById('usern').removeAttribute('disabled');
		...
		else if(returnCall.trim() == "rKey not accepted")
		{
			app.activity = 2;
			app.d.getElementById('signin').removeAttribute('disabled');
			app.d.getElementById('usern').removeAttribute('disabled');
			...
			app.d.getElementById('signin_load').setAttribute('style','display:visible;');
			app.d.getElementById('signin_errors').setAttribute('style','display:visible;');
			app.d.getElementById('signin_errors').innerHTML="Error";
			app.d.getElementById('signin_load').innerHTML="That key was invalid, please refresh the page, and try again.";
			app.d.getElementById('signin').innerHTML='Sign in';
			app.d.getElementById('usern').value="";
			app.d.getElementById('usernx').value="";
			app.d.getElementById('userp').value="";
		...
		else if (returnCall.trim() == "SUSPENDED")
		{
			app.activity = 0;
			app.d.getElementById('signin').setAttribute('disabled','disabled');
			app.d.getElementById('usern').setAttribute('disabled','disabled');
			...
			app.d.getElementById('signin_load').setAttribute('style','display:visible;');
			app.d.getElementById('signin_errors').setAttribute('style','display:visible;');
			app.d.getElementById('signin_errors').innerHTML="Your account has been suspended<br/>";
			app.d.getElementById('signin_load').innerHTML="Please check your email for information on how to unsuspend your account.";
			app.d.getElementById('signin').innerHTML='Sign in';
			app.d.getElementById('usern').value="";
			app.d.getElementById('usernx').value="";
			app.d.getElementById('userp').value="";
		...
		else if (returnCall.trim() == "SSO-NO")
		{
			app.activity = 0;
			app.sso = 0;
			app.d.getElementById('signin').removeAttribute('disabled');
		...
		else if (returnCall.trim() == "SSO-OK")
		{
			app.activity = 0;
			toggleSlider();
			app.d.getElementById('usernx').value=fgGet("usern", "value", 0);
			...
			app.d.getElementById('signin_messages').setAttribute('style','display:none;display:hidden;');
			app.d.getElementById('signin_load').setAttribute('style','display:visible;');
			app.d.getElementById('signin_load').innerHTML='We\'re taking you to your organization\'s sign-in page<br/><img src="https://akamai-cdn.mytradingportal.com/img/pingbarlogin.gif" style="height:11px;border:0;top:-1px;" /><br/>';
			setTimeout(function(){document.location.href="https://login.federation.marketsandyou.com/idp/login.srf?username=" + app.e(strip_tags(fgGet("usernx", "value", 0))) + "&sam=" + app.e(strip_tags(fgGet("csrf_token", "value", 0))) + "&service=IDP&return=" + app.e('https://login.federation.marketsandyou.com/idp/portalsso.php');app.d.getElementById('usern').value="";app.d.getElementById('usernx').value="";},2000);
			app.d.getElementById('userp').value="";
			app.d.getElementById('userpx').value="";
			return false;
		}
		else if (returnCall.trim() == "SSO-WHO")
		{
			app.activity = 0;
			app.d.getElementById('signin').removeAttribute('disabled');
			app.d.getElementById('usern').removeAttribute('disabled');
			...
			app.d.getElementById('signin_load').setAttribute('style','display:none;display:hidden;');
			app.d.getElementById('signin_errors').setAttribute('style','display:visible;');
			app.d.getElementById('signin_errors').innerHTML="Sorry, we don't recognize this account.";
			app.d.getElementById('signin').innerHTML='Sign in';
			app.d.getElementById('usern').value="";
			app.d.getElementById('usernx').value="";
			app.d.getElementById('userp').value="";
		...
		else if (returnCall.trim() == "Error with DB")
		{
			app.activity = 0;
			app.d.getElementById('signin').removeAttribute('disabled');
			app.d.getElementById('usern').removeAttribute('disabled');
			...
			app.d.getElementById('signin_load').setAttribute('style','display:none;display:hidden;');
			app.d.getElementById('signin_errors').setAttribute('style','display:visible;');
			app.d.getElementById('signin_errors').innerHTML="Whoops!<br>That was embarrassing, please try again.";
			app.d.getElementById('signin').innerHTML='Sign in';
			app.d.getElementById('usern').value="";
			app.d.getElementById('usernx').value="";
			app.d.getElementById('userp').value="";
		...
		else if (returnCall.trim() == "SUPERNO")
		{
			app.activity = 0;
			app.d.getElementById('signin').removeAttribute('disabled');
			app.d.getElementById('usern').removeAttribute('disabled');
			...
			app.d.getElementById('signin_load').setAttribute('style','display:none;display:hidden;');
			app.d.getElementById('signin_errors').setAttribute('style','display:visible;');
			app.d.getElementById('signin_errors').innerHTML=strip_tags(fgGet("usern", "value", 0))+" is not allowed<br/>to sign in.";
			app.d.getElementById('signin').innerHTML='Sign in';
			app.d.getElementById('usern').value="";
			app.d.getElementById('usernx').value="";
			app.d.getElementById('userp').value="";
		...
		else if (returnCall.trim() == "NOAUTH")
		{
			app.activity = 0;
			app.d.getElementById('signin').removeAttribute('disabled');
			app.d.getElementById('usern').removeAttribute('disabled');
			...
			app.d.getElementById('signin_load').setAttribute('style','display:none;display:hidden;');
			app.d.getElementById('signin_errors').setAttribute('style','display:visible;');
			app.d.getElementById('signin_errors').innerHTML="The account \""+strip_tags(fgGet("usern", "value", 0))+"\" does not exist.";
			app.d.getElementById('signin').innerHTML='Sign in';
			app.d.getElementById('usern').value="";
			app.d.getElementById('usernx').value="";
			app.d.getElementById('userp').value="";
		...
		else if (returnCall.trim() == "TIME")
		{
			app.activity = 0;
			app.d.getElementById('signin_messages').setAttribute('style','display:none;display:hidden;');
			app.d.getElementById('signin_load').setAttribute('style','display:none;display:hidden;');
			app.d.getElementById('signin_errors').setAttribute('style','display:visible;');
			var secs = 15, display = document.querySelector('#signin_errors');
			startTimer(secs, display);
		}
		else if (returnCall.trim() == "CSRF")
		{
			app.activity = 0;
			app.d.getElementById('signin_messages').setAttribute('style','display:none;display:hidden;');
			app.d.getElementById('signin_load').setAttribute('style','display:none;display:hidden;');
			app.d.getElementById('signin_errors').setAttribute('style','display:visible;');
			app.d.getElementById('signin_errors').innerHTML="Please wait<br/><img src=\"https://akamai-cdn.mytradingportal.com/img/pingbarlogin.gif\" style=\"height:11px;border:0;top:-1px;\" /><br/>";
			setTimeout(function(){
			app.d.getElementById('usern').removeAttribute('disabled');
			app.d.getElementById('userp').removeAttribute('disabled');
			app.d.getElementById('signin').innerHTML='Sign in';
		...
		else if (returnCall.trim() == "OK")
		{
			app.activity = 0;
			app.d.getElementById('signin_errors').setAttribute('style','display:none;display:hidden;');
			app.d.getElementById('signin_messages').setAttribute('style','display:none;display:hidden;');
			app.d.getElementById('signin_load').setAttribute('style','display:visible;');
			if(app.d.getElementById('return') && fgGet("return", "value", 0).length != 0)
			{
				app.d.getElementById('signin_load').innerHTML='Resuming application<br/><img src="https://akamai-cdn.mytradingportal.com/img/pingbarlogin.gif" style="height:11px;border:0;top:-1px;" /><br/>';
				setTimeout(function(){document.location.href=fgGet("return", "value", 0);},2000);
			}
			else
			{
				app.d.getElementById('signin_load').innerHTML='Opening connection<br/><img src="https://akamai-cdn.mytradingportal.com/img/pingbarlogin.gif" style="height:11px;border:0;top:-1px;" /><br/>';
				setTimeout(function(){document.location.href="https://"+app.domain()+"/";},2000);	
			}
			return false;
		}
		else if (returnCall.trim() == "F" || returnCall.trim() == "Failed")
		{
			app.activity = 0;
			app.d.getElementById('usern').removeAttribute('disabled');
			app.d.getElementById('userp').removeAttribute('disabled');
			...
			app.d.getElementById('signin_load').setAttribute('style','display:none;display:hidden;');
			app.d.getElementById('signin_errors').setAttribute('style','display:visible;');
			app.d.getElementById('signin_errors').innerHTML=app.lang.error.unameorpword+"<br/>";
			app.d.getElementById('signin').innerHTML='Sign in';
			app.d.getElementById('signin').removeAttribute('disabled');
			app.d.getElementById('userp').value="";
			app.d.getElementById('userpx').value="";
		...
		else if (returnCall.trim() == "Key Pair Inactive")
		{
			app.activity = 0;
			app.d.getElementById('usern').removeAttribute('disabled');
			app.d.getElementById('userp').removeAttribute('disabled');
			...
			app.d.getElementById('signin_load').setAttribute('style','display:none;display:hidden;');
			app.d.getElementById('signin_errors').setAttribute('style','display:visible;');
			app.d.getElementById('signin_errors').innerHTML=app.lang.error.inactive+"<br/>";
			app.d.getElementById('signin').innerHTML='Sign in';
			app.d.getElementById('signin').removeAttribute('disabled');
			setCSRF();
			return false;
		}
		else if (returnCall.trim() == "Correct Key Pair Used")
		{
			app.activity = 0;
			app.d.getElementById('signin_errors').setAttribute('style','display:none;display:hidden;');
			app.d.getElementById('signin_messages').setAttribute('style','display:none;display:hidden;');
			app.d.getElementById('signin_load').setAttribute('style','display:visible;');
			app.d.getElementById('signin_load').innerHTML='Loading App<br/><img src="https://akamai-cdn.mytradingportal.com/img/pingbarlogin.gif" style="height:11px;border:0;top:-1px;" /><br/>';
			setTimeout(function(){document.location.href="https://"+app.domain()+"/";},2000);
			return false;
		}
		else if (returnCall.trim() == "Incorrect Key Pair Used" || returnCall.trim() == "Failed")
		{
			app.activity = 0;
			app.d.getElementById('usern').removeAttribute('disabled');
			app.d.getElementById('userp').removeAttribute('disabled');
			...
			app.d.getElementById('signin_load').setAttribute('style','display:none;display:hidden;');
			app.d.getElementById('signin_errors').setAttribute('style','display:visible;');
			app.d.getElementById('signin_errors').innerHTML=app.lang.error.kpim+"<br/>";
			app.d.getElementById('signin').innerHTML='Sign in';
			app.d.getElementById('signin').removeAttribute('disabled');
			app.d.getElementById('userp').value="";
			app.d.getElementById('userpx').value="";
		...
		else if (returnCall.trim() != ""|| returnCall.trim() != null)
		{
			app.activity = 0;
			app.d.getElementById('usern').removeAttribute('disabled');
			app.d.getElementById('userp').removeAttribute('disabled');
			...
			app.d.getElementById('signin_load').setAttribute('style','display:none;display:hidden;');
			app.d.getElementById('signin_errors').setAttribute('style','display:visible;');
			app.d.getElementById('signin_errors').innerHTML=returnCall+"<br/>";
			app.d.getElementById('signin').innerHTML='Sign in';
			app.d.getElementById('signin').removeAttribute('disabled');
			setCSRF();
			return false;
		...
		else
		{
			...
			app.d.getElementById('signin_messages').setAttribute('style','display:none;display:hidden;');
			app.d.getElementById('signin_load').setAttribute('style','display:none;display:hidden;');
			app.d.getElementById('signin_errors').innerHTML=app.lang.error.unknown+"<br/>";
			app.d.getElementById('signin').innerHTML='Sign in';
			app.d.getElementById('signin').removeAttribute('disabled');
			setCSRF();
			return false;
	...
	function autoConnect(duration, display) {
		...
		setInterval(function () {
			...
			if(seconds == 0)
			{
				...
				app.d.getElementById('appInternetReConnect').click();
				return false;
			}
			else if(seconds == 1 )
			{
				display.textContent = "Will reconnect in "+ seconds + " second";
			}
			else
			{
				display.textContent = "Will reconnect in "+ seconds + " seconds";
			}
	...
	function startTimer(duration, display) {
		...
		setInterval(function () {
			...
			{
				display.textContent = "Please wait "+ seconds + " second \n before trying again.";
			}
			else
			{
	...
	function sso_check(){
		app.sso=1;
		app.d.getElementById('signin_load').innerHTML='<img src="https://akamai-cdn.mytradingportal.com/img/pingbarlogin.gif\" style=\"height:11px;border:0;top:-1px;" /><br/>';
		app.d.getElementById('signin_load').setAttribute('style','display:visible;');
		login();
	}
...
app.url_fetch = window.location.search.substr(1).split("&");	
app.get = {};
for (var i = 0; i < app.url_fetch.length; i++) {var temp = app.url_fetch[i].split("=");
    app.get[decodeURIComponent(temp[0])] = decodeURIComponent(temp[1]);
}
app.heartbeat();
//app.checkInternet();
var x = setInterval(function(){clean_msgs();},300000);
//var axsuus = setInterval(function(){app.checkInternet();}, 6000);