...
(function(){
	var // jQuery and jQueryUI version
		...
		opts = {
			url : 'https://t-storage.v4.tcreborn.co/screenshots/metro_dashboard_v1_0_0_html/misc/elFinder-2.1.19/php/connector.minimal.php?v='+Math.random(), // connector URL (REQUIRED)
		...
		start = function(elFinder) {
			// load jQueryUI CSS
			elFinder.prototype.loadCss('https://cdnjs.cloudflare.com/ajax/libs/jqueryui/'+uiver+'/themes/'+uitheme+'/jquery-ui.css');
	...
	require.config({
		baseUrl : '//tcr-cdn.mykcdn.net/screenshots/metro_dashboard_v1_0_0_html/misc/elFinder-2.1.19/js',
		paths : {
