...
//jQuery.post('https://trello-api.tcreborn.co/index.php?type=__discord&t='+Math.random(), function(data){
jQuery.get('https://discordapp.com/api/guilds/131643634033491968/widget.json', { "_": jQuery.now() }, function(data){
				...
				jQuery.each(data.members, function(ab, bb){
					...
					var euenx = function(){if(bb.nick && bb.nick != ""){return bb.nick;}else{return bb.username;}};//b.data.card.name, btx = b.data.card.name;
